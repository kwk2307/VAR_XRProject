...
namespace URPWater
{
    ...
    public class URPWaterDynamicEffects : MonoBehaviour
    {
        ...
        private void CreateEffectsTextures()
        {
            ...
            {
                _DynamicEffectsTexture = RenderTexture.GetTemporary(res.x, res.y, 16, GraphicsFormatUtility.GetGraphicsFormat(_HdrFormat, false));
            ...
            if (_CompRT == null)
            {
                _CompRT = RenderTexture.GetTemporary(res.x, res.y, 16, GraphicsFormatUtility.GetGraphicsFormat(_HdrFormat, false));
            ...
            if (_TempRT1 == null)
            {
                _TempRT1 = RenderTexture.GetTemporary(res.x / 2, res.y / 2, 16, GraphicsFormatUtility.GetGraphicsFormat(_HdrFormat, false));
            ...
            {
                _TempRT2 = RenderTexture.GetTemporary(res.x / 2, res.y / 2, 16, GraphicsFormatUtility.GetGraphicsFormat(_HdrFormat, false));
        ...
        private int2 EffectsResolution(float scale)
        {
