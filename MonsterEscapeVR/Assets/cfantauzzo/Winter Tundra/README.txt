...
If using HDRP version, you will need to manually add the diffusion profiles located in FTEP_HDRP>Diffusion Profiles to your High Definition Render Pipeline Asset. Alternatively, you can simply use the existing Render Pipeline asset located in the FTEP_HDRP folder.

If using URP version, under pipeline asset, enable HDR and set Grading Mode to High Dynamic Range for best quality. Alternatively, you can simply use the existing Render Pipeline asset located in the FTEP_URP folder.
