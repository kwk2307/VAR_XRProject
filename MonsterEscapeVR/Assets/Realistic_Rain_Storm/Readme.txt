...
New to version 1.5 is "Heavy Rain", an alternative version of the rain that uses individual streaks of rain particles. A potential advantage of this version is that it is better solution when the camera looks vertically up at the rain - ideally suited to a VR camera.
